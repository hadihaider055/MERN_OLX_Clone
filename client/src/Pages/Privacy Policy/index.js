...
const PrivacyPolicy = () => {
  return (
    <Layout>
      <div style={{ width: "93vw", margin: "0 auto", marginTop: "30px" }}>
        <h2 style={{ textAlign: "center", fontFamily: "Georama,sans-serif" }}>
          Privacy Policy
        </h2>
        <p
          style={{
        ...
        >
          At OLX_CLONE, accessible from https://olx-clone02.herokuapp.com/, one
          of our main priorities is the privacy of our visitors. This Privacy
          Policy document contains types of information that is collected and
          recorded by OLX_CLONE and how we use it. If you have additional
          ...
          the information that they shared and/or collect in OLX_CLONE. This
